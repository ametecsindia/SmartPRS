...
(function () {
    ...
    var RQ_MAP = {
        ...
        'exits': { m: 'exits', title: 'Exit & FnF', amount: false, fields: [{ k: 'last_working_day', l: 'Last Working Day', t: 'date' }, { k: 'reason', l: 'Reason' }, { k: 'id_surrendered', l: 'ID card surrendered', opts: ['Yes', 'No', 'N/A'] }, { k: 'access_revoked', l: 'System / portal access revoked', opts: ['Yes', 'No', 'N/A'] }, { k: 'dra_id_returned', l: 'DRA / authorisation ID returned', opts: ['Yes', 'No', 'N/A'] }, { k: 'data_handed_over', l: 'Borrower data / files handed over', opts: ['Yes', 'No', 'N/A'] }, { k: 'knowledge_transfer', l: 'Knowledge transfer done', opts: ['Yes', 'No', 'Pending'] }, { k: 'final_clearance', l: 'Final clearance', opts: ['Cleared', 'Withheld', 'Pending'] }, { k: 'cleared_by', l: 'Cleared By' }, { k: 'cleared_on', l: 'Cleared On', t: 'date' }, { k: 'clearance_remarks', l: 'Clearance Remarks' }] },
    ...
    function howItWorksScreen() {
        ...
        var cards = [
            ...
            card('fa-clock', '#0ea5e9', 'Working Shifts', 'Define named shifts (General / Morning / Night) under Attendance &rarr; Working Shifts, set each employee&rsquo;s default shift on their profile, and override day-wise via the Roster. Attendance and payroll judge everyone against THEIR shift; an end time earlier than the start = night shift across midnight, and its per-night allowance lands in payroll automatically.'),
            card('fa-shield-halved', '#dc2626', 'RBI Audit Reports', 'Statutory &amp; Compliance &rarr; Audit Reports: filter by company / department / team, pick one or many agents, and generate compliance audit PDFs on your own letterhead — DRA, PCC, references, code-of-conduct and complaints checked against live records with a verdict per agent. Bulk mode produces one file with a summary page; View Sample shows the format instantly.'),
    ...
    var SP_TOUR = [
        ...
        { screen: 'shifts', target: null, title: 'Working shifts — day and night', text: 'Define named shifts like General, Morning or Night. Attendance and payroll judge each person against THEIR shift, and night workers get their allowance automatically, per night actually worked.' },
        ...
        { screen: 'audit-reports', target: null, title: 'One-click R B I audit file', text: 'Pick agents by company, department or team and generate compliance audit reports on your own letterhead — single, or one bulk file with a verdict per agent. This is what you hand the bank.' },
    ...
    var MASTER_MAP = {
        ...
        'overtime': { type: 'overtime', title: 'Overtime Register', sub: 'Record overtime per agent (date, hours, rate multiplier). Amount auto-computes from CTC if left blank. Export the Overtime register from Reports.', fields: [
            { k: 'employee', l: 'Employee', src: 'emp' }, { k: 'company_name', l: 'Company', src: 'company' }, { k: 'ot_date', l: 'OT Date', type: 'date' }, { k: 'hours', l: 'OT Hours', type: 'number' }, { k: 'multiplier', l: 'Rate Multiplier', type: 'select', opts: ['1', '1.5', '2'], optLabels: ['1x (normal)', '1.5x', '2x (double)'] }, { k: 'amount', l: 'Amount (₹, auto if blank)', type: 'number' }, { k: 'status', l: 'Status', type: 'select', opts: ['pending', 'approved', 'paid'], optLabels: ['Pending', 'Approved', 'Paid'] }] },
        'policies': { type: 'policies', title: 'Policy Repository', sub: 'Board-approved recovery / collection policies, code of conduct and SOPs — versioned, with owner, effective date, board-approval date and review-due. Set "Acknowledgement required" for policies agents must accept.', fields: [
            { k: 'title', l: 'Policy Title' }, { k: 'category', l: 'Category', type: 'select', opts: ['recovery_policy', 'code_of_conduct', 'sop', 'data_privacy', 'grievance', 'hr', 'other'], optLabels: ['Recovery / Collection Policy', 'Code of Conduct', 'SOP', 'Data Privacy (DPDP)', 'Grievance Redressal', 'HR Policy', 'Other'] }, { k: 'version', l: 'Version (e.g. v1.0)' }, { k: 'owner', l: 'Policy Owner' }, { k: 'effective_date', l: 'Effective Date', type: 'date' }, { k: 'board_approved_on', l: 'Board Approved On', type: 'date' }, { k: 'review_due', l: 'Next Review Due', type: 'date' }, { k: 'ack_required', l: 'Acknowledgement Required', type: 'select', opts: ['1', '0'], optLabels: ['Yes — agents must acknowledge', 'No'] }, { k: 'reference', l: 'Document Link / Reference' }, { k: 'summary', l: 'Summary', type: 'textarea' }, { k: 'status', l: 'Status', type: 'select', opts: ['active', 'superseded', 'draft'], optLabels: ['Active (current)', 'Superseded', 'Draft'] }] },
        ...
        'companies': { type: 'companies', title: 'Companies', sub: 'Group companies — the signed-up company is the Master; additional companies are Subsidiaries', fields: [
            { k: 'name', l: 'Company Name' }, { k: 'is_master', l: 'Company Level', type: 'select', opts: ['1', '0'], optLabels: ['Master company', 'Subsidiary'] }, { k: 'type', l: 'Type' }, { k: 'pan', l: 'PAN' }, { k: 'gstin', l: 'GSTIN' }, { k: 'address', l: 'Address' }, { k: 'phone', l: 'Phone' }, { k: 'email', l: 'Email' }, { k: 'website', l: 'Website' }, { k: 'grievance_officer', l: 'Grievance Officer' }, { k: 'grievance_phone', l: 'Grievance Phone' }, { k: 'grievance_email', l: 'Grievance Email' }, { k: 'status', l: 'Status', type: 'select', opts: ['active', 'inactive'], optLabels: ['Active', 'Inactive'] }] },
