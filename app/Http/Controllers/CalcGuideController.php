    ...
    private static function sections(): array
    {
        return [
            ...
            [
                ...
                'points' => [
                    '<b>The attendance period is the calendar month</b> — 1st to the last day. Every punch, leave and OT entry inside those dates belongs to that month\'s payslip.',
                    '<b>The pay DATE is configurable:</b> Salary Schedules / Pay Cycle → Pay Day N (1–28) pays on the Nth of the following month; no schedule → month-end. A company-specific schedule row beats an all-company row.',
            ...
            [
                ...
                'points' => [
                    ...
                    '<b>Professional Tax:</b> state-wise monthly slabs built in for 16 states (keyed on each employee\'s PT State), PT-free states show ₹0, Maharashtra February charges ₹300 so the year totals ₹2,500. No state set → the configured default slab.',
