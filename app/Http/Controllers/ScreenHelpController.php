    ...
    private static function payrollModule(): array
    {
        return [
            ...
            'salary-gen' => [
                ...
                's' => ['Choose company and month, click Generate.', 'Non-working days are automatic: weekly offs come from Statutory & Compliance → PF & ESIC → Edit Rates → Weekly offs (Sunday, 2nd & 4th Saturday, etc.); festival holidays are added/deleted in Leave → Holidays. Both are excluded from LOP working days.', 'Open a few payslips in the draft — check one normal case, one with leave, one with commission.', 'Send the run for approval; after approval, payslips publish and employees are notified.'],
