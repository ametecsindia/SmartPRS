...
<div class="card">
    ...
    <form method="POST" action="{{ url('/app/activate') }}">
        @csrf
        <label style="display:block;font-size:11px;font-weight:700;color:#64748b;text-transform:uppercase;letter-spacing:.6px;margin-bottom:7px">Licence key</label>
        <input type="text" name="key" placeholder="SPRS-XXXX-XXXX-XXXX-XXXX" autocomplete="off" required>
